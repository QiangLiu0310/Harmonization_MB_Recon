%[~,~]=recon_ScanArchive(filename);
addpath G:\'My Drive'\'matlab code'\'GE Recon code'\ver30\

%directory = fileparts(mfilename('fullpath'));
directory1 = 'G:\My Drive\matlab code\GE Recon code\ver30_test\';
directory2 = 'Archive_Series30\';
directory = [directory1 directory2];
%filename = fullfile(directory, '/Data/CartesianScanArchive/ScanArchive.h5');
%filename = fullfile(directory, 'Archive_Series24\ScanArchive_BRIGHAM750WMR1_20231012_074436048.h5');
%filename = fullfile(directory, 'Archive_Series35\ScanArchive_BRIGHAM750WMR1_20231012_080611280.h5');
filename = fullfile('ScanArchive_LONGWOOD30MR2_20240229_212206655.h5');
%filename = fullfile('ScanArchive_LONGWOOD30MR2_20240229_212132280.h5');
...
% meic Allocate 5D Image and kspace space (with phases)
ima = complex(zeros(xRes, yRes, nChannels, zRes, phs));
ksp = complex(zeros(xRes, yRes, nChannels, zRes, phs));
...
save([directory 'ksp.mat'], "ksp");
save([directory 'ima.mat'], "ima");
