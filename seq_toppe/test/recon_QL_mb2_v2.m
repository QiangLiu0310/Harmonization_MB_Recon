...
data_path1='/data/pnlx/home/ql087/data_bwh/product_scan_rescan/2024_04_09_ge_sub3/Exam16500/Series11/'; % ref
...
tmp=strcat(data_path1,'ScanArchive_LONGWOOD30MR2_20240409_214426269.h5'); % the last one
pfile = fullfile(tmp);
...
tmp=strcat(data_path1,'ScanArchive_LONGWOOD30MR2_20240409_214354649.h5'); % the first one
pfile = fullfile(tmp);
archive = GERecon('Archive.Load', pfile);
