...
data_path1='/data/pnlx/home/ql087/data_bwh/product_scan_rescan/2024_08_21_ge_sub1/Exam18233/Series11/'; % ref
...
tmp=strcat(data_path1,'ScanArchive_LONGWOOD30MR2_20240821_221322187.h5'); % the last one
pfile = fullfile(tmp);
...
tmp=strcat(data_path1,'ScanArchive_LONGWOOD30MR2_20240821_221250606.h5'); % the first one
pfile = fullfile(tmp);
archive = GERecon('Archive.Load', pfile);
...
cd /data/pnlx/home/ql087/data_processing/2024_recon_reproducibility/sub1/ge/split-grappa/
save('pa_scan2_sg.mat','img')
