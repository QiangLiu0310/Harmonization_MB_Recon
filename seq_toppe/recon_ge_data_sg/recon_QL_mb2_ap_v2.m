...
tmp=strcat(data_path1,'ScanArchive_LONGWOOD30MR2_20240329_210643557.h5'); % the last one
pfile = fullfile(tmp);
...
tmp=strcat(data_path1,'ScanArchive_LONGWOOD30MR2_20240329_210611939.h5'); % the first one
pfile = fullfile(tmp);
archive = GERecon('Archive.Load', pfile);
