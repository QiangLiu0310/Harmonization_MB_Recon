...
data_path='/data/pnlx/home/ql087/data_bwh/product_scan_rescan/2024_03_28_ge_sub2/Exam16351/Series11/'; % image
data_path1='/data/pnlx/home/ql087/data_bwh/product_scan_rescan/2024_03_28_ge_sub2/Exam16351/Series14/'; % ref
...
tmp=strcat(data_path1,'ScanArchive_LONGWOOD30MR2_20240329_214020589.h5'); % the last one
pfile = fullfile(tmp);
...
tmp=strcat(data_path1,'ScanArchive_LONGWOOD30MR2_20240329_213948976.h5'); % the first one
pfile = fullfile(tmp);
archive = GERecon('Archive.Load', pfile);
...
tmp=strcat(data_path,'ScanArchive_LONGWOOD30MR2_20240329_212758926.h5');
pfile = fullfile(tmp);
archive = GERecon('Archive.Load', pfile);
