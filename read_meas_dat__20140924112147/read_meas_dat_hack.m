...
%     end;
    ...
    load /autofs/space/baldur_002/users/jaejin/database/qalas/dat_qalas_R2_1mm/not_use/dim.mat
    load /autofs/space/baldur_002/users/jaejin/database/qalas/dat_qalas_R2_1mm/not_use/dimensions.mat
...
%
  ...
  if ( DO__RETURN_STRUCT ),
    ...
    if ~exist('mdh(end).flTimeStamp_ms')
        meas.acqtime = [meas_timestart, 0];
    else
