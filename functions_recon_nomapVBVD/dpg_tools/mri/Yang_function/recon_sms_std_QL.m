function [img] = recon_sms_std_QL( varargin )
%-------------------------------------
...
clear refscan_pc clear C2 refscan
sz = size(k_trgt);
...
% Kimage_short  =squeeze(Kimage(:,:,:,1,:,:));% short QL

clear Kimage vrgf_image image_raw image_raw_tmp
%% recon

NRep=2; % QL
Kimage_short=Kimage_short(:,:,:,:,1:2);
