function [img_recon] = recon_SMS_data_XCLv3_parfor_QL_v1(kspace_cor, ky_idx,sens_gre,AccY, AccZ,PhaseShiftBase,show_mercy)
if (PhaseShiftBase ~=0)
...
parfor ii_slc=1:size(kspace_cor,4)
    slc_select = ii_slc;
    if AccZ>1
        for ii_temp=2:AccZ
