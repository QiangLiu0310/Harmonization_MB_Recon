function [covmtxFull, g, g_ind, n, n_ind] = mrir_array_GRAPPA_gfactor_analytical__breuer_Full( w, KernalSize_Slice, G, R_inplane, covmtx, NCol, NLin, varargin)
...
%% slice-Grappa
covmtxFull_step1 = zeros(size(K,1),size(K,2),nCha,nCha,NslicesEX);
