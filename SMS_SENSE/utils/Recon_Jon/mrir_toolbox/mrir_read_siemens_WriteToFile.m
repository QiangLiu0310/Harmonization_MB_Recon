function ima = mrir_read_siemens_WriteToFile(imafile, filetype, varargin)
%MRIR_READ_SIEMENS_WRITETOFILE
%
%  ima = mrir_read_siemens_WriteToFile(imafile, filetype)
%
%  example:
%
%     ima_0001 = mrir_read_siemens_WriteToFile('WriteToFile_0001.ima', 'short');
%
...
% $Id: mrir_read_siemens_WriteToFile.m,v 1.1 2007/08/28 18:51:58 jonp Exp $
%**************************************************************************%
  ...
  %************************************************************************%
  %%% $Source: /space/padkeemao/1/users/jonp/cvsjrp/PROJECTS/IMAGE_RECON/mrir_toolbox/mrir_read_siemens_WriteToFile.m,v $
  %%% Local Variables:
  %%% mode: Matlab
  %%% fill-column: 76
  %%% comment-column: 0
