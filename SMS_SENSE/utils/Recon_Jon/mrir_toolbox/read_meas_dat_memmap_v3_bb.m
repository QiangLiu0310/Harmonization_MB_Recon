...
function [meas] = read_meas_dat_memmap_v3_1(filename,nRepToRead,BeginRep,SMSdata,ascendingSlice_acq,data_isvd,AccZ)
...
if exist([save_fname(1:end-4) '_Raw.mat'],'file') ~= 2
    ...
    if  (isfield(meas_first, 'patrefscan'))
        ...
        % BB: comment out patref phase cor since it is flash based
