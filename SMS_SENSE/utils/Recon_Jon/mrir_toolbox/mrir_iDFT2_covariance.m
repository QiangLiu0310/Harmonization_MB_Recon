...
% $Id: mrir_iDFT2_covariance.m,v 1.1 2008/12/12 02:56:07 jonnyreb Exp $
%**************************************************************************%
  ...
  %************************************************************************%
  %%% $Source: /space/padkeemao/1/users/jonnyreb/cvsjrp/PROJECTS/IMAGE_RECON/mrir_toolbox/mrir_iDFT2_covariance.m,v $
  %%% Local Variables:
  %%% mode: Matlab
  %%% fill-column: 76
  %%% comment-column: 0
