...
function [meas] = read_meas_dat_memmap_v3_2(filename,nRepToRead,BeginRep,SMSdata,ascendingSlice_acq,data_isvd,AccZ)
...
NslicesEX = AccZ;
meas.evp.NColMeas=meas.prot.iNoOfFourierColumns;
...
nPE_Raw =size(SegOneLines ,2)+size(SegTwoLines ,2);
