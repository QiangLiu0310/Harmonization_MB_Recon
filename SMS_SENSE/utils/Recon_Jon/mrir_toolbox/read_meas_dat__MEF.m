function varargout = read_meas_dat(filename, user_options, iEco)
...
%**************************************************************************%
  ...
  if ( exist('read_meas_prot', 'file') && IS__VB13A_RELEASE_VERSION ),
    [prot, evp] = read_meas_prot(filename);
  end;
...
%%      end;
    ...
    if ( DO__MDH_BINARY && ...
	 ~exist('read_meas_dat__mdh_binary', 'file') ),
...
%  scan_patrefscan          = matrixtype([]);
  ...
  try,
	...
	mdh = read_meas_dat__mdh_binary(mdh_binary);
      else,
...
%%%        end;
	...
	continue;
      ...
      pos_pat = pos;
      pos_pat(02) = pos(02) - evp.NFirstRefLin + 1;
      pos_pat(09) = pos(09) - evp.NFirstRefPar + 1;
      
      pos_dat = pos;
      pos_dat(02) = ( (pos(02) - evp.NFirstLin) / evp.NAFLin ) + 1;
      pos_dat(09) = ( (pos(09) - evp.NFirstPar) / evp.NAFPar ) + 1;
      ...
      elseif ( read_meas__extract_bit(mdh(idx).aulEvalInfoMask(1), EvalInfoMask.MDH_PATREFSCAN) ),
        ...
        elseif ( read_meas__extract_bit(mdh(idx).aulEvalInfoMask(1), EvalInfoMask.MDH_PATREFANDIMASCAN) ),
          ...
          patrefscan(...
              :, pos_pat(02), ...
              pos_pat(03), pos_pat(04), pos_pat(05), pos_pat(06), pos_pat(07), pos_pat(08), pos_pat(09), ...
              pos_pat(10), pos_pat(11), pos_pat(12), pos_pat(13), pos_pat(14), pos_pat(15), pos_pat(16)) = adc_cplx;
          ...
          data(...
              :, pos_dat(02), ...
              pos_dat(03), pos_dat(04), pos_dat(05), pos_dat(06), pos_dat(07), pos_dat(08), pos_dat(09), ...
              pos_dat(10), pos_dat(11), pos_dat(12), pos_dat(13), pos_dat(14), pos_dat(15), pos_dat(16)) ...
              = adc_cplx;
...
%              1, pos_pat(02), ...
%              pos_pat(03), pos_pat(04), pos_pat(05), pos_pat(06), pos_pat(07), pos_pat(08), pos_pat(09), ...
%              pos_pat(10), pos_pat(11), pos_pat(12), pos_pat(13), pos_pat(14), pos_pat(15), pos_pat(16)) = mdh(idx).ulScanCounter;
...
%      meas.scan_patrefscan = scan_patrefscan;
    ...
    if ( exist('read_meas_prot', 'file') && IS__VB13A_RELEASE_VERSION ),
      [meas.prot, meas.evp] = deal(prot, evp);
    end;
