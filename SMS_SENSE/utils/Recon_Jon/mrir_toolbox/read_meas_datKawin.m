...
%%      end;
    ...
    if ( DO__MDH_EXTRACT_BINARY && ...
	 ~exist('read_meas_dat__fft_scalefactors', 'file') ),
      
      DO__MDH_EXTRACT_BINARY = 0;      
...
%               if pos(02) == 1 && pos(03) == 1 && pos(07) == 1 % i.e. only do for line1, chn1, rep1
...
%               testFlag = [testFlag; mdh(idx).flTra];
%           else
%               keyboard
%           end
        %%%%%
