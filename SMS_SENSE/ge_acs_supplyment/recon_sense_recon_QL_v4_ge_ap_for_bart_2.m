...
data_path1='/data/pnlx/home/ql087/data_bwh/product_scan_rescan/2024_08_21_ge_sub1/Exam18233/Series5/'; % ref
...
tmp=strcat(data_path1,'ScanArchive_LONGWOOD30MR2_20240821_215440653.h5'); % the last one
pfile = fullfile(tmp);
...
tmp=strcat(data_path1,'ScanArchive_LONGWOOD30MR2_20240821_215408766.h5'); % the first one
pfile = fullfile(tmp);
archive = GERecon('Archive.Load', pfile);
...
img_patref=flipdim(fft2cc(k_trgt),2);
